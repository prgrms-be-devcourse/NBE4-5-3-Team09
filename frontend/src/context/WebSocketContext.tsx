...
import type { TickerDto, OrderbookDto, TradeDto, CandleChartDto, ChatMessageDto } from '@/types';
...
export const WebSocketProvider = ({
  ...
  const [chatMessages, setChatMessages] = useState<Record<string, ChatMessageDto[]>>({});
